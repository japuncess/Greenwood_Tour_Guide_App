...
public class BetweenLocationActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageView = findViewById(R.id.ImageViewBetween);
    ...
    public void continueTour(View view) {
        if(Locations.currentLocation != 8) {
            Locations.currentLocation++;
            robot.speak(TtsRequest.create("I will now take you to the " + Data.LocationData.get(Locations.currentLocation).Name, true));
        }
        else
            endTour(view);
    }
    ...
    public void endTour(View view) {
        ...
        robot.speak(TtsRequest.create("Thanks for participating on this tour.", true));
    ...
    public void onTtsStatusChanged(TtsRequest ttsRequest) {
        ...
        String location = Data.LocationData.get(Locations.currentLocation).Name;
...
//                robot.speak(TtsRequest.create("Completed", false));
                ...
                if (Locations.currentLocation == Data.LocationData.size() - 1) {
                ...
                if (location.toLowerCase().equals(Data.LocationData.get(Locations.currentLocation).Name.toLowerCase())) {
                    robot.speak(TtsRequest.create(Data.LocationData.get(Locations.currentLocation).Description, true));
                    Resources res = getResources();
                    ImageView imageView = findViewById(R.id.ImageViewBetween);
                    String imageName = Data.LocationData.get(Locations.currentLocation).Image;
