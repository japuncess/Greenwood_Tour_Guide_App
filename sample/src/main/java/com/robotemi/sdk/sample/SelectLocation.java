...
public class SelectLocation extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageView = findViewById(R.id.ImageViewEnd);
    ...
    public void goToWorkspace(View view) {
    ...
    public void goToDeakinLaunchpad(View view) {
        ...
        robot.speak(TtsRequest.create("I will now take you to the " + Data.LocationData.get(4).Name, true));

    }

    public void goToDeakinStaffOffice(View view) {
    ...
    public void goToOpenArea(View view) {
        Locations.currentLocation = 6;
        robot.speak(TtsRequest.create("I will now take you to the " + Data.LocationData.get(6).Name, true));
    }

    public void goToToilets(View view) {
        Locations.currentLocation = 7;
        robot.speak(TtsRequest.create("I will now take you to the " + Data.LocationData.get(7).Name, true));

    }

    public void goToPrintArea(View view) {
        Locations.currentLocation = 8;
        robot.speak(TtsRequest.create("I will now take you to the " + Data.LocationData.get(8).Name, true));

    }

    public void goToEntrance(View view) {
        Locations.currentLocation = 0;
    ...
    public void onNlpCompleted(NlpResult nlpResult) {
        ...
        Toast.makeText(SelectLocation.this, nlpResult.action, Toast.LENGTH_SHORT).show();
    ...
    public void onTtsStatusChanged(TtsRequest ttsRequest) {
        ...
        if (ttsRequest.getSpeech().equals(("I will now take you to the " + Data.LocationData.get(0).Name)) && ttsRequest.getStatus().toString().equals("COMPLETED")) {
            String str0 = Data.LocationData.get(0).Name;
            robot.goTo(str0.toLowerCase().trim());
        }
        ...
        if (ttsRequest.getSpeech().equals(("I will now take you to the " + Data.LocationData.get(4).Name)) && ttsRequest.getStatus().toString().equals("COMPLETED")) {
            String str4 = Data.LocationData.get(4).Name;
            robot.goTo(str4.toLowerCase().trim());
        }
        ...
        if (ttsRequest.getSpeech().equals(("I will now take you to the " + Data.LocationData.get(6).Name)) && ttsRequest.getStatus().toString().equals("COMPLETED")) {
            String str6 = Data.LocationData.get(6).Name;
            robot.goTo(str6.toLowerCase().trim());
        }
        if (ttsRequest.getSpeech().equals(("I will now take you to the " + Data.LocationData.get(7).Name)) && ttsRequest.getStatus().toString().equals("COMPLETED")) {
            String str7 = Data.LocationData.get(7).Name;
            robot.goTo(str7.toLowerCase().trim());
        }
        if (ttsRequest.getSpeech().equals(("I will now take you to the " + Data.LocationData.get(8).Name)) && ttsRequest.getStatus().toString().equals("COMPLETED")) {
            String str8 = Data.LocationData.get(8).Name;
            robot.goTo(str8.toLowerCase().trim());
        }
